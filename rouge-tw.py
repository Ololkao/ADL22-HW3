...
class NewMetric(datasets.Metric):
    ...
    def _compute(self, predictions, references):
        ...
        rouge = get_rouge(predictions, references, avg=True, ignore_empty=False)
        rouge_1, rouge_2, rouge_l = round(rouge['rouge-1']['f'], 4), round(rouge['rouge-2']['f'], 4), round(rouge['rouge-l']['f'], 4)
